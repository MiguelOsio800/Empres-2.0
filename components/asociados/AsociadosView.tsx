...
const AsociadosGestionView: React.FC<AsociadosGestionViewProps> = (props) => {
    ...
    const handleCreateNew = () => {
        const newAsociado: Asociado = {
            ...
            nombre: '',
            cedula: '',
            fechaNacimiento: new Date(Date.now() - new Date().getTimezoneOffset() * 60000).toISOString().split('T')[0],
            fechaIngreso: new Date(Date.now() - new Date().getTimezoneOffset() * 60000).toISOString().split('T')[0],
            telefono: '',
            correoElectronico: '',
            direccion: '',
            observaciones: '',
